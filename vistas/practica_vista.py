...
class Practica_vista:
    ...
    def __init__(self,obj_clase, usuario):
        ...
        label1 = tk.Label(subframe1, text="ELIGE UNA PRACTICA SUPERVISADA",  wraplength=100, anchor="w")
        ...
        clase_num = obj_clase.orden #uso la primer clase

        self.btn_leccion1 = tk.Button(subframe3, text="Práctica 1",command=lambda: self.mostrar_leccion(usuario,frame1,frame2, clase_num,4))
        self.btn_leccion1.pack(padx=5, pady=5)

        self.btn_leccion2 = tk.Button(subframe3, text="Práctica 2",command=lambda: self.mostrar_leccion(usuario,frame1,frame2,clase_num,5))
        self.btn_leccion2.pack(padx=5, pady=5)

        self.btn_leccion3 = tk.Button(subframe3, text="Práctica 3", command=lambda: self.mostrar_leccion(usuario,frame1,frame2,clase_num,6))
        self.btn_leccion3.pack(padx=5, pady=5)
        #bandera para detener las ejecuciones
        self.flag = False
        root.protocol("WM_DELETE_WINDOW", lambda: self.cerrar())

        self.root.mainloop()
        
        #leccion segun orden
        #melodias:
        #4 -> DO MI RE FA MI SOL FA LA SOL SI
        #5 -> SI SI DO RE RE DO SI LA SOL SOL LA SI SI2 LA LA
        #6 -> SI DO RE LA LA DO MI RE DO SI DO RE MI DO LA LA


    def mostrar_leccion(self, usuario, frame1,frame2,clase_num,leccion_num):
        ...
        if cap.isOpened():
            ...
            def tocar_nota(nota_origen):
                ...
                def play_and_wait():
                    ...
                    if secuencia:  # Verificar si la secuencia no está vacía
                    ...
                    if not secuencia:
                        ...
                        messagebox.showinfo("Mensaje", "Excelente has logrado completar con éxito la practica")
            ...
            def mostrar_frame():
                ...
                if not self.flag:
                     label_img.after(10, mostrar_frame)
